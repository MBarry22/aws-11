...
WORKDIR /src
COPY ["week-11-csharp.csproj", "week-11-csharp/"]
RUN dotnet restore "week-11-csharp/week-11-csharp.csproj"

WORKDIR "/src/week-11-csharp"
COPY . .
RUN dotnet build "week-11-csharp.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "week-11-csharp.csproj" \
...
Execute unit tests
```
cd "week-11-csharp/test/week-11-csharp.Tests"
dotnet test
```

Deploy function to AWS Lambda
```
cd "week-11-csharp/src/week-11-csharp"
